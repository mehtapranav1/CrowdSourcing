...
<div class="container">
	...
	<div class="row">
		<h2 class="text-center">Chemistry Question Bank</h2>

	</div>
	<div class="row">
   <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
          <a class="w3-bar-item w3-button w3-border-bottom w3-large" href="http://localhost/crowdsourcing/"><img src="home.png" style="width:25%;"></a></nav>
...
<script >
   ...
   function ajaxcall2(){
    console.log("ajaxcall");
               ...
               url: 'chemretrive.php',    //the script to call to get data          
