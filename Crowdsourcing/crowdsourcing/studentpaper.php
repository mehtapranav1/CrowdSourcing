...
<nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
          <a class="w3-bar-item w3-button w3-border-bottom w3-large" href="index.html"><img src="home.png" style="width:25%;"></a></nav>
<div class="container">

	<div class="row">
		<h2 class="text-center">Model Question paper</h2>

	</div>
	<div class="row" style="margin-top: 18%; margin-left:25%; margin-right: 50%;">
    <button type="button" class="btn btn-success" style="margin-bottom: 10px; margin-left: 50%;" data-title="Edit" data-toggle="modal" data-target="#automate"><span class="glyphicon glyphicon-plus-sign"></span> Provide Question Bank</button>
...
<div class="modal fade" id="automate" tabindex="-1" role="dialog" aria-labelledby="edit" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <h4 class="modal-title custom_align" id="Heading">Which Subject Do You Seek!</h4>
      </div>
...
<script >
   function createpaper() {
    ...
    var ajaxdata1 = {class:cclass,subject:subject};
    ajaxcall1(ajaxdata1);
   ...
   function ajaxcall1(data) {
     console.log(data);
      $.ajax({ 
               type:"POST",
               url: 'file:///C:/wamp64/www/adminpanel/retrivedata.php',    //the script to call to get data          
   ...
   function ajaxcall2(){
    console.log("ajaxcall");
               ...
               url: 'generatepaper.php',    //the script to call to get data          
